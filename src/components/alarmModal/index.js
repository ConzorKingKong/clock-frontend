...
export default class AlarmModal extends Component {
  ...
  onButtonClick (e) {
    if (e.target === this.stopButton || !this.modal.contains(e.target)) this.props.setAppState({alarm: false, alarmTime: {}})
  }
  ...
  render () {
    ...
    const {hours, minutes, seconds, ampm, day} = this.props.alarmTime
    return (
